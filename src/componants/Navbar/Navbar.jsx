...
const Navbar = ({ handleOrderPopup }) => {
    return (
        ...
        <div className="shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200 fixed w-[100%] z-40 ">
            ...
            <div className="bg-primary/40 py-2 ">
                <div className="container flex justify-between items-center">
                    ...
                    <div className='flex justify-between items-center gap-1'>
                        <div className="relative  justify-between group hidden
                        sm:block">
                            <input
                                type="text"
                                placeholder="Search"
                        ...
                        <button
                         ...
                         transition-all duration-200 text-white py-1 px-4 rounded-full flex
                          items-center gap-3 mr-8 sm:mr-0 group">
                            ...
                            <ul>
                                {DropdownLinks.map((data) => (
                                    <li key={data.id}>
                                        ...
                                        rounded-md p-2 hover:bg-primary/20'>{data.name}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>
